BeginTestSection["TimeAggregation Tests"]
Begin["FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`"]

(* --- merged from: TimeAggregation_test1.wlt --- *)
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-VG5BVR@@Tests/ProcessModels/TimeAggregation.wlt:9,1-18,2"
]

(* --- merged from: TimeAggregation_test2.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-WONDVI@@Tests/ProcessModels/TimeAggregation.wlt:25,1-33,2"
]

(* --- merged from: TimeAggregation_test3.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-U10LZ4@@Tests/ProcessModels/TimeAggregation.wlt:40,1-57,2"
]

(* --- merged from: TimeAggregation_test4.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-4E6B0H@@Tests/ProcessModels/TimeAggregation.wlt:64,1-124,2"
]

(* --- merged from: TimeAggregation_test5.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-5RD3WD@@Tests/ProcessModels/TimeAggregation.wlt:131,1-256,2"
]

(* --- merged from: TimeAggregation_test6.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-3UKC3U@@Tests/ProcessModels/TimeAggregation.wlt:263,1-303,2"
]

(* --- merged from: TimeAggregation_test7.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-6IK7G0@@Tests/ProcessModels/TimeAggregation.wlt:310,1-341,2"
]

(* --- merged from: TimeAggregation_test8.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-3T8NC0@@Tests/ProcessModels/TimeAggregation.wlt:348,1-429,2"
]

(* --- merged from: TimeAggregation_test9.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-QZ97FD@@Tests/ProcessModels/TimeAggregation.wlt:436,1-572,2"
]

(* --- merged from: TimeAggregation_test10.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-I7KL2Y@@Tests/ProcessModels/TimeAggregation.wlt:596,1-624,2"
]

(* --- merged from: TimeAggregation_test11.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-V2C2PB@@Tests/ProcessModels/TimeAggregation.wlt:648,1-697,2"
]

(* --- merged from: TimeAggregation_test12.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-CFO0NZ@@Tests/ProcessModels/TimeAggregation.wlt:721,1-774,2"
]

(* --- merged from: TimeAggregation_test13.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-IJTW55@@Tests/ProcessModels/TimeAggregation.wlt:798,1-820,2"
]

(* --- merged from: TimeAggregation_test14.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
				...
				Simplify[
					SameQ[0,
						Coefficient[
							ReplaceAll[
								FernandoDuarte`LongRunRisk`Tools`TimeAggregation`growth[
									FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`dc, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`t, "TimeAggregation" -> FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h, "numPeriods" -> FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k, "v0" -> Function[{FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`t, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`j, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k, v, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`im}, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`F[FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`t]]
								],
								FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`dc[__] -> FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`dcX
							],
							FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`dcX, 0
	...
	{}
	,
	TestID->"TimeAggregation_20251223-DKZMIY@@Tests/ProcessModels/TimeAggregation.wlt:844,1-872,2"
]

(* --- merged from: TimeAggregation_test15.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
					...
					SameQ[0,
						Coefficient[
							ReplaceAll[
								ReplaceAll[
									FernandoDuarte`LongRunRisk`Tools`TimeAggregation`growth[
										FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`dc, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`t, "TimeAggregation" -> FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h, "numPeriods" -> FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k, "v0" -> Function[{FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`t, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`j, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k, v, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`im}, FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`F[FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`j]]
									],
	...
	{}
	,
	TestID->"TimeAggregation_20251223-1OCPF0@@Tests/ProcessModels/TimeAggregation.wlt:899,1-933,2"
]

(* --- merged from: TimeAggregation_test16.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-PTZZZH@@Tests/ProcessModels/TimeAggregation.wlt:966,1-1000,2"
]

(* --- merged from: TimeAggregation_test17.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-ZR63ZD@@Tests/ProcessModels/TimeAggregation.wlt:1039,1-1073,2"
]

(* --- merged from: TimeAggregation_test18.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-Y57R4E@@Tests/ProcessModels/TimeAggregation.wlt:1118,1-1173,2"
]

(* --- merged from: TimeAggregation_test19.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-M73FMI@@Tests/ProcessModels/TimeAggregation.wlt:1218,1-1273,2"
]

(* --- merged from: TimeAggregation_test20.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-9SSRN3@@Tests/ProcessModels/TimeAggregation.wlt:1318,1-1331,2"
]

(* --- merged from: TimeAggregation_test21.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-437MTH@@Tests/ProcessModels/TimeAggregation.wlt:1382,1-1638,2"
]

(* --- merged from: TimeAggregation_test22.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-Q8KJ84@@Tests/ProcessModels/TimeAggregation.wlt:1692,1-1721,2"
]

(* --- merged from: TimeAggregation_test23.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-CKQ6IG@@Tests/ProcessModels/TimeAggregation.wlt:1778,1-1868,2"
]

(* --- merged from: TimeAggregation_test24.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-ZIIB7K@@Tests/ProcessModels/TimeAggregation.wlt:1928,1-2033,2"
]

(* --- merged from: TimeAggregation_test25.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-VUNRZY@@Tests/ProcessModels/TimeAggregation.wlt:2096,1-2149,2"
]

(* --- merged from: TimeAggregation_test26.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-F1GTBF@@Tests/ProcessModels/TimeAggregation.wlt:2215,1-2328,2"
]

(* --- merged from: TimeAggregation_test27.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-LGVV9H@@Tests/ProcessModels/TimeAggregation.wlt:2397,1-2438,2"
]

(* --- merged from: TimeAggregation_test28.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-GL6029@@Tests/ProcessModels/TimeAggregation.wlt:2510,1-2561,2"
]

(* --- merged from: TimeAggregation_test29.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-L6DDF0@@Tests/ProcessModels/TimeAggregation.wlt:2636,1-2689,2"
]

(* --- merged from: TimeAggregation_test30.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-KVH063@@Tests/ProcessModels/TimeAggregation.wlt:2767,1-2893,2"
]

(* --- merged from: TimeAggregation_test31.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-DS0RIH@@Tests/ProcessModels/TimeAggregation.wlt:2974,1-3101,2"
]

(* --- merged from: TimeAggregation_test32.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-4KUPNC@@Tests/ProcessModels/TimeAggregation.wlt:3185,1-3322,2"
]

(* --- merged from: TimeAggregation_test33.wlt --- *)
FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`longTest = False;
Off[General::stop];
	Needs @ "FernandoDuarte`LongRunRisk`Tools`TimeAggregation`";
...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251223-5QVB6Z@@Tests/ProcessModels/TimeAggregation.wlt:3406,1-3415,2"
]
