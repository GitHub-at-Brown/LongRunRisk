...
$phic = FernandoDuarte`LongRunRisk`Model`Parameters`phic;
$phig = FernandoDuarte`LongRunRisk`Model`Parameters`phig;
$phidc = FernandoDuarte`LongRunRisk`Model`Parameters`phidc;
$mup = FernandoDuarte`LongRunRisk`Model`Parameters`mup;
$muc = FernandoDuarte`LongRunRisk`Model`Parameters`muc;
$mud = FernandoDuarte`LongRunRisk`Model`Parameters`mud;
$rhop = FernandoDuarte`LongRunRisk`Model`Parameters`rhop;
$rhocp = FernandoDuarte`LongRunRisk`Model`Parameters`rhocp;
$rhog = FernandoDuarte`LongRunRisk`Model`Parameters`rhog;
$rhodp = FernandoDuarte`LongRunRisk`Model`Parameters`rhodp;
$xip = FernandoDuarte`LongRunRisk`Model`Parameters`xip;
$xic = FernandoDuarte`LongRunRisk`Model`Parameters`xic;
$xid = FernandoDuarte`LongRunRisk`Model`Parameters`xid;
$Esg = FernandoDuarte`LongRunRisk`Model`Parameters`Esg;
$delta = FernandoDuarte`LongRunRisk`Model`Parameters`delta;
