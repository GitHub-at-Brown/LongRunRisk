...
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-9Z43N8@@Tests/TimeAggregation.wlt:3,1-12,2"
]
VerificationTest[
	Off[General::stop];
	...
	{}
	,
	TestID->"TimeAggregation_20251212-M0KIT7@@Tests/TimeAggregation.wlt:13,1-23,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-TVX60I@@Tests/TimeAggregation.wlt:24,1-33,2"
]
VerificationTest[
	!SameQ[Names @ "*growth", {}]
	,
	...
	{}
	,
	TestID->"TimeAggregation_20251212-PSE5CY@@Tests/TimeAggregation.wlt:34,1-42,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-6OZ7ES@@Tests/TimeAggregation.wlt:43,1-60,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-JR7WOM@@Tests/TimeAggregation.wlt:61,1-121,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-KTHK7O@@Tests/TimeAggregation.wlt:122,1-247,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-E9N97U@@Tests/TimeAggregation.wlt:248,1-288,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-6H2QJO@@Tests/TimeAggregation.wlt:289,1-320,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-6GQKOR@@Tests/TimeAggregation.wlt:321,1-402,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-U9387I@@Tests/TimeAggregation.wlt:403,1-539,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-4X04BB@@Tests/TimeAggregation.wlt:540,1-568,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-30IVYC@@Tests/TimeAggregation.wlt:569,1-618,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-YIKOHN@@Tests/TimeAggregation.wlt:619,1-672,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-LN7YKR@@Tests/TimeAggregation.wlt:673,1-695,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-7WQ8EH@@Tests/TimeAggregation.wlt:696,1-724,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-2NHLV7@@Tests/TimeAggregation.wlt:725,1-759,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-116KC9@@Tests/TimeAggregation.wlt:760,1-794,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-KJDKW1@@Tests/TimeAggregation.wlt:795,1-829,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-Z8EOSC@@Tests/TimeAggregation.wlt:830,1-885,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-YDBR0S@@Tests/TimeAggregation.wlt:886,1-941,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-E9TH86@@Tests/TimeAggregation.wlt:942,1-955,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-8VMCOV@@Tests/TimeAggregation.wlt:956,1-1212,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 2;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-O9VIMP@@Tests/TimeAggregation.wlt:1213,1-1242,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 2;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-9BMKMH@@Tests/TimeAggregation.wlt:1243,1-1333,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-LRTPYQ@@Tests/TimeAggregation.wlt:1334,1-1439,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-TLYXV6@@Tests/TimeAggregation.wlt:1440,1-1493,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-MQ0IEO@@Tests/TimeAggregation.wlt:1494,1-1607,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-IVLZ3B@@Tests/TimeAggregation.wlt:1608,1-1649,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-JT5NEF@@Tests/TimeAggregation.wlt:1650,1-1701,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-ZJ5G0H@@Tests/TimeAggregation.wlt:1702,1-1755,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-U27M6W@@Tests/TimeAggregation.wlt:1756,1-1882,2"
]
VerificationTest[
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`h = 3;
	FernandoDuarte`LongRunRisk`Tests`Tools`TimeAggregation`k = 1;
	...
	{}
	,
	TestID->"TimeAggregation_20251212-VDTAFB@@Tests/TimeAggregation.wlt:1883,1-2010,2"
]
VerificationTest[
	Apply[And,
		Simplify[
	...
	{}
	,
	TestID->"TimeAggregation_20251212-S1WP30@@Tests/TimeAggregation.wlt:2011,1-2148,2"
]
VerificationTest[
	On[General::stop];
	True
	...
	{}
	,
	TestID->"TimeAggregation_20251212-3QJRCU@@Tests/TimeAggregation.wlt:2149,1-2158,2"
] 
VerificationTest[
