BeginTestSection["bilinear-handling Tests"]
Begin["FernandoDuarte`LongRunRisk`Tests`ParamQuadSolve`bilinearHandling`"]

(* --- merged from: bilinear-handling_test1.wlt --- *)
...
VerificationTest[
 ...
 ], True, TestID -> "bilinear-linear-behaviour@@Tests/ParamQuadSolve/bilinear-handling.wlt:12,1-24,2"
]

(* --- merged from: bilinear-handling_test2.wlt --- *)
Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`ParamQuadSolve`"];
...
VerificationTest[
 Module[{eqns2, vars2, res2, sol, signMap, conds, yRule, xRule},
   ...
   MemberQ[conds, z >= 1]
 ], True, TestID -> "mixed-quadratic-linear-parameter-dependence@@Tests/ParamQuadSolve/bilinear-handling.wlt:34,1-50,2"
]
