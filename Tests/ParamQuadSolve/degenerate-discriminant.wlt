...
(* --- merged from: degenerate-discriminant_test1.wlt --- *)
...
VerificationTest[Length[rules$] >= 1, True, TestID -> "enumerated@@Tests/ParamQuadSolve/degenerate-discriminant.wlt:18,1-18,136"]

(* --- merged from: degenerate-discriminant_test2.wlt --- *)
Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`ParamQuadSolve`"];
...
VerificationTest[Length[uniqueX$] == 1, True, TestID -> "collapsed-branches@@Tests/ParamQuadSolve/degenerate-discriminant.wlt:34,1-34,146"]
