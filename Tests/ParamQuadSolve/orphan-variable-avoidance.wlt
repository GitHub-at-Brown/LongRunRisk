BeginTestSection["orphan-variable-avoidance Tests"]
Begin["FernandoDuarte`LongRunRisk`Tests`ParamQuadSolve`orphanVariableAvoidance`"]

(* --- merged from: orphan-variable-avoidance_test1.wlt --- *)
...
VerificationTest[
  ...
  True,
  TestID -> "orphan-simple-avoidance@@Tests/ParamQuadSolve/orphan-variable-avoidance.wlt:12,1-35,2"
]

(* --- merged from: orphan-variable-avoidance_test2.wlt --- *)
Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`ParamQuadSolve`"];
...
(* --- merged from: orphan-variable-avoidance_test3.wlt --- *)
Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`ParamQuadSolve`"];
...
VerificationTest[
  ...
  True,
  TestID -> "orphan-longrunrisk-eq4-deferred@@Tests/ParamQuadSolve/orphan-variable-avoidance.wlt:77,1-119,2"
]

(* --- merged from: orphan-variable-avoidance_test4.wlt --- *)
Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`ParamQuadSolve`"];
...
VerificationTest[
  ...
  True,
  TestID -> "orphan-no-orphans-in-deferred@@Tests/ParamQuadSolve/orphan-variable-avoidance.wlt:129,1-176,2"
]
