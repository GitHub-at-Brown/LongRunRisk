...
eir = ToExpression["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`Private`extractIntervalsFromReduce"];
...
VerificationTest[
  Quiet@eir[x < -1, x, "InteriorShrink" -> 0, "RootUpperBound" -> 10],
  {},
...
VerificationTest[
  Quiet@eir[x > 20, x, "RootUpperBound" -> 15],
  {},
