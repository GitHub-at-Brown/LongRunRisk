...
VerificationTest[
  Module[{keysToKeep, raw, toCatalog, realModels},
...
VerificationTest[
  Module[{keysToKeep, raw, formatted, toCatalog, formatModels, realModels},
    toCatalog = FernandoDuarte`LongRunRisk`Tools`NiceOutput`toCatalog;
...
VerificationTest[
  Module[{keysToKeep, raw, formatted, strings, modelNames, toCatalog, formatModels, realModels},
    toCatalog = FernandoDuarte`LongRunRisk`Tools`NiceOutput`toCatalog;
    formatModels = FernandoDuarte`LongRunRisk`Tools`NiceOutput`formatModels;
    realModels = FernandoDuarte`LongRunRisk`Model`Catalog`models;
    keysToKeep = {"name", "shortname", "bibRef", "desc", "enabled", "stateVars", "parameters"};
...
VerificationTest[
  Module[{keysToKeep, raw, formatted, strings, toCatalog, formatModels, realModels},
    toCatalog = FernandoDuarte`LongRunRisk`Tools`NiceOutput`toCatalog;
    formatModels = FernandoDuarte`LongRunRisk`Tools`NiceOutput`formatModels;
    realModels = FernandoDuarte`LongRunRisk`Model`Catalog`models;
    keysToKeep = {"name", "shortname", "bibRef", "desc", "enabled", "stateVars", "parameters"};
