...
VerificationTest[
	...
	{}
	,
	TestID->"SolveEulerEq_20260103-SBLUZ0@@Tests/SolveEulerEq.wlt:3,1-12,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"SolveEulerEq_20260103-XVFOTH@@Tests/SolveEulerEq.wlt:13,1-24,2"
]
VerificationTest[
	Off[General::stop];
		...
		Apply[And,
			{
				...
				If[Equal[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`bond, 1],
					Apply[And,
						Map[Function[Or[NumberQ[#], MatchQ[#, _Missing]]],
							Map[Values, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`sol]
						]
					],
	...
	Do[
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc = {"FindRootOptions" -> {"MaxIterations" -> 100}};
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`resWc = Quiet[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @@ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc]];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`resWcSol = Quiet[
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`savedKernels, {}, {}, Sequence @@ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc]
		];
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`trueA0 = Part[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "coeffsSolutionN", 1]["A"][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`A @ 0];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`intervalRealA0 = Part[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "coeffsSolutionN", 1]["IntervalA"];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0 = Mean @ {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`trueA0, Mean @ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`intervalRealA0};
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`trueB0 = Part[Part[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "coeffsSolutionN", 1]["Stocks", 1], 1]["B"][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`B[1][0]];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`intervalRealB0 = Part[Part[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "coeffsSolutionN", 1]["Stocks", 1], 1]["IntervalB"];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Epd0 = Mean @ {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`trueB0, Mean @ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`intervalRealB0};
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`resNoPd = Quiet[
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
				"UpdatePd" -> False,
				"initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0}, "Epd" -> {{FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Epd0}}|>
			]
		];
					...
					FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`wcRulesFirst[
						Quiet[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[
								...
								"initialGuess" -> <|"Ewc" -> FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`intervalRealA0|>,
								Sequence @@ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc
							]
						]
					]
				],
				FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsQWcRules[
					FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`wcRulesFirst[
						Quiet[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[
								FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
								"initialGuess" -> <|"Ewc" -> Append[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`trueA0]|>,
								Sequence @@ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc
							]
						]
					]
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`resWcNewBondParams = Quiet[
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`savedKernels, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`newBondParams, {}, Sequence @@ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc]
		];
	...
	{}
	,
	TestID->"SolveEulerEq_20260103-KLQZZX@@Tests/SolveEulerEq.wlt:25,1-340,2"
] 
VerificationTest[
  $ContextPath = Select[$ContextPath,  !(StringContainsQ[#1, "FernandoDuarte`LongRunRisk`"] && StringEndsQ[#1, "Private`"]) & ]; True,
  True,
  TestID -> "Untitled-24@@Tests/SolveEulerEq.wlt:341,1-345,2"
]
End[]
EndTestSection[]
