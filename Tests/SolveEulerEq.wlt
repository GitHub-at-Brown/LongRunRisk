...
VerificationTest[
	...
	{}
	,
	TestID->"SolveEulerEq_20251102-F0YRT3@@Tests/SolveEulerEq.wlt:3,1-12,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"SolveEulerEq_20251102-99VK98@@Tests/SolveEulerEq.wlt:13,1-23,2"
]
VerificationTest[
	Off[General::stop];
	...
	Do[
		...
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[
				And,
				{
					Equal[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs @ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
						...
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, {}],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}]
					],
					Equal[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`newParameters],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`newParameters, {}],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`newParameters, {}, {}],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`newParameters, {}]
					],
					Equal[
		...
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Quiet[
				Apply[And,
					Flatten[
						{
							Map[
								...
								Map[
									Function[
										{
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, Sequence @ #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, Sequence @@ #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @ {}, #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @@ {}, #],
											...
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @ #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @@ #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Most @ #, Last @ #],
											FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence @ Most @ #, Last @ #]
										}
									],
							...
							Map[
								...
								Map[
									Function @ {
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, #],
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, First @ #, Rest @ #],
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, First @ #, Sequence @ Rest @ #],
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Sequence[First @ #, Rest @ #]],
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, Most @ #, {Last @ #}],
										FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {First @ #}, Rest @ #]
									},
		...
		FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Equal[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc,
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc],
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsWc[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["wc"],
				FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`optsWc
			]
		];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solWc1 = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "MaxIterations" -> 1, "initialGuess" -> <|"Ewc" -> {3}|>];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solWc2 = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "MaxIterations" -> 1, "initialGuess" -> <|"Ewc" -> {1}|>];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solWc1 = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[
				FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
				"FindRootOptions" -> {"MaxIterations" -> 1},
				"initialGuess" -> <|"Ewc" -> {3}|>
			];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m1 = Block[
				...
				Reap[
					Module[{},
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "MaxIterations" -> 1, "initialGuess" -> <|"Ewc" -> {4}|>];
					];
					$MessageList
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m2 = Block[
				...
				Reap[
					Module[{},
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "MaxIterations" -> 3, "initialGuess" -> <|"Ewc" -> {4}|>];
					];
					$MessageList
				]
			];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m1 = Block[
				{$MessagePrePrint = Sow, $MessageList = {}},
				Reap[
					Module[{}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "PrintResidualsNorm" -> False];];
					$MessageList
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m2 = Block[
				{$MessagePrePrint = Sow, $MessageList = {}},
				Reap[
					Module[{}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "PrintResidualsNorm" -> True];];
					$MessageList
				]
			];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c1 = Not[
				TrueQ[
					CheckAbort[
						Check[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "CheckResiduals" -> False],
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c2 = TrueQ[
				CheckAbort[
					Check[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "CheckResiduals" -> True],
						Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
					],
					True
				]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c1 = Not[
				TrueQ[
					CheckAbort[
						Check[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "CheckResiduals" -> True, "Tol" -> 1],
							Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
						],
						True
					]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c2 = TrueQ[
				CheckAbort[
					Check[
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "CheckResiduals" -> True, "Tol" -> (10. ^ -20)],
						Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
					],
					True
				]
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsWcPd = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
			"UpdatePd" -> True,
			"initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0}, "Epd" -> {{5.5}}|>
		];
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Equal[
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0}|>],
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel,
					"UpdatePd" -> False,
					"initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`Ewc0}, "Epd" -> {{5.5}}|>
				]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Equal[
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`ig}|>],
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, "initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`ig}|>],
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsWc[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["wc"],
					FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "parameters", {}, "Ewc0" -> FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`ig
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Not[
				TrueQ[
					Equal[
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsSol[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, {}, {}, MaxIterations -> 1],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, MaxIterations -> 1]
					]
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind = FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind + 1;
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Equal[
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsWc[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["wc"], FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "parameters", {}],
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsWc[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["wc"],
					FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "parameters", {}, "Ewc0" -> FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`ig
				],
				FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "initialGuess" -> <|"Ewc" -> {FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`ig}|>]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Not[
				TrueQ[
					Equal[
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsWc[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["wc"],
							FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "parameters", {}, MaxIterations -> 1
						],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, MaxIterations -> 1]
					]
				]
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[And,
			{
				FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsQWc[
		...
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[
				...
				{
					Equal[
						FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsQWc[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "initialGuess" -> <|"Ewc" -> {4.}|>]],
						FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsQWc[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "initialGuess" -> <|"Ewc" -> {4}|>]]
					],
					Equal[
						FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`coeffsQWc[
		...
		FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solBond = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["bond"],
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc
		];
		FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solNomBond = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["nombond"],
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc
		];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[And,
			{
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solBondNew = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["bond"],
		...
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solNomBondNew = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["nombond"],
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`newBondParams, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`solWcNewBondParams
		];
		FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[And,
			{
		...
		If[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`longTest,
			FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solBond = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[
				...
				FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc, "Method" -> Automatic, "Precision" -> 1
			];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[
				And,
				{
					SameQ[
						FilterRules[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "MaxMaturity" -> FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity],
							FernandoDuarte`LongRunRisk`Model`EndogenousEq`Private`coefb @ _
						],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["bond"],
							FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc
						]
					],
					SameQ[
						FilterRules[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateNomBond" -> True, "MaxMaturity" -> FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity],
							FernandoDuarte`LongRunRisk`Model`EndogenousEq`Private`coefnb @ _
						],
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`updateCoeffsBond[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["coeffsSolution"]["nombond"],
							FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel @ "params", {}, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity, FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`solWc
						]
					]
				}
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Apply[
				And,
				{
					SameQ[
						Sort[
							FilterRules[
								FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBonds" -> True, "MaxMaturity" -> FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`maxMaturity],
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m1 = Block[
				{$MessagePrePrint = Sow, $MessageList = {}},
				Reap[
					FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "PrintResidualsNorm" -> False];
					$MessageList
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m2 = Block[
				{$MessagePrePrint = Sow, $MessageList = {}},
				Reap[
					FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "PrintResidualsNorm" -> True];
					$MessageList
				]
			];
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`outTests[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel["shortname"]][FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`ind] = Equal[ReleaseHold @ FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`m1, {{}, {}}];
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c1 = Not[
				TrueQ[
					CheckAbort[
						Check[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "CheckResiduals" -> False],
							Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
						],
						True
					]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c2 = TrueQ[
				CheckAbort[
					Check[
						FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "CheckResiduals" -> True],
						Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
					],
					True
				]
			...
			FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`c1 = Not[
				TrueQ[
					CheckAbort[
						Check[
							FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs[FernandoDuarte`LongRunRisk`Tests`ComputationalEngine`SolveEulerEq`thisModel, "UpdateBond" -> True, "CheckResiduals" -> True, "Tol" -> 1],
							Abort[], FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`Private`checks::largeresid
						],
						True
					]
	...
	{}
	,
	TestID->"SolveEulerEq_20251102-MVASU2@@Tests/SolveEulerEq.wlt:24,1-852,2"
] 
VerificationTest[
  $ContextPath = Select[$ContextPath,  !(StringContainsQ[#1, "FernandoDuarte`LongRunRisk`"] && StringEndsQ[#1, "Private`"]) & ]; True,
  True,
  TestID -> "Untitled-24@@Tests/SolveEulerEq.wlt:853,1-861,8"
]
End[]
EndTestSection[]
