(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/Core/PacletizeResources_test1.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`PacletizeResourcestest1`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["PacletizeResources"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`PacletizeResources`"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`"]; ],
    HoldComplete[VerificationTest[And @@ Simplify[{ !PacletFind["MaTeX"] === {},  !PacletFind["PacletizedResourceFunctions"] === {}, MemberQ[$Packages, "MaTeX`"], PacletFind["MaTeX"][[1]]["Version"] === "1.7.10",  !PacletFind[Names["*NeedsDefinitions"]] === {},  !PacletFind[Names["*SetSymbolsContext"]] === {}}], True, {}, TestID -> "PacletizeResources_20251223-96HVAR@@Tests/Core/PacletizeResources_test1.wlt:6,1-25,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "PacletizeResources_test1",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../Core/PacletizeResources_test1.wlt"
};
