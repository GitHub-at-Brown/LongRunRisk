(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/SolveEulerEq/addCoeffsSolutionN.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`addCoeffsSolutionN`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["addCoeffsSolutionN Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`SolveEulerEq`addCoeffsSolutionN`"]],
    ...
    HoldComplete[VerificationTest[Head[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`addCoeffsSolutionN], Symbol, TestID -> "addCoeffsSolutionN-symbol-exists@@Tests/SolveEulerEq/addCoeffsSolutionN.wlt:16,1-20,2"]],
    HoldComplete[Off[General::shdw]; ],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`"]; ],
    HoldComplete[On[General::shdw]; ],
    HoldComplete[$timeLimit = 5; ],
    HoldComplete[VerificationTest[Head[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs], Symbol, TestID -> "updateCoeffs-symbol-exists@@Tests/SolveEulerEq/addCoeffsSolutionN.wlt:34,1-38,2"]],
    HoldComplete[Off[General::shdw]; ],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`"]; ],
    HoldComplete[On[General::shdw]; ],
    HoldComplete[$timeLimit = 5; ],
    HoldComplete[VerificationTest[StringQ[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`addCoeffsSolutionN::usage], True, TestID -> "addCoeffsSolutionN-has-usage@@Tests/SolveEulerEq/addCoeffsSolutionN.wlt:52,1-56,2"]],
    HoldComplete[Off[General::shdw]; ],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`"]; ],
    HoldComplete[On[General::shdw]; ],
    HoldComplete[$timeLimit = 5; ],
    HoldComplete[VerificationTest[StringQ[FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs::usage], True, TestID -> "updateCoeffs-has-usage@@Tests/SolveEulerEq/addCoeffsSolutionN.wlt:70,1-74,2"]],
    HoldComplete[Off[General::shdw]; ],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`"]; ],
    HoldComplete[On[General::shdw]; ],
    HoldComplete[$timeLimit = 5; ],
    HoldComplete[VerificationTest[Module[{opts, updateCoeffs}, updateCoeffs = FernandoDuarte`LongRunRisk`ComputationalEngine`SolveEulerEq`updateCoeffs; opts = Options[updateCoeffs]; ListQ[opts]], True, TestID -> "updateCoeffs-options-is-list@@Tests/SolveEulerEq/addCoeffsSolutionN.wlt:88,1-97,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "addCoeffsSolutionN",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../SolveEulerEq/addCoeffsSolutionN.wlt"
};
