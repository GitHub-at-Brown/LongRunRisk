(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/ParamQuadSolve/steps-linear-quadratic.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`stepslinearquadratic`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["steps-linear-quadratic Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`ParamQuadSolve`stepsLinearQuadratic`"]],
    ...
    HoldComplete[VerificationTest[Module[{x, y, eq, vars, r, steps}, eq = {x^2 - 5 == 0, y + 2*x - 3 == 0}; vars = {x, y}; r = pqs[eq, vars, "DomainOption" -> Reals, "ValidationOption" -> False]; steps = r["Diagnostics"]["Steps"]; MemberQ[steps, {"quadratic", x}]], True, {}, TestID -> "has-quadratic-x@@Tests/ParamQuadSolve/steps-linear-quadratic.wlt:10,1-21,2"]],
    HoldComplete[VerificationTest[Module[{x, y, eq, vars, r, steps}, eq = {x^2 - 5 == 0, y + 2*x - 3 == 0}; vars = {x, y}; r = pqs[eq, vars, "DomainOption" -> Reals, "ValidationOption" -> False]; steps = r["Diagnostics"]["Steps"]; MemberQ[steps, {"linear", y}] || MemberQ[steps, {"linear2", y}]], True, {}, TestID -> "has-linear-y@@Tests/ParamQuadSolve/steps-linear-quadratic.wlt:23,1-34,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "steps-linear-quadratic",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../ParamQuadSolve/steps-linear-quadratic.wlt"
};
