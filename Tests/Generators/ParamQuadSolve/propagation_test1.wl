(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/ParamQuadSolve/propagation_test1.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`propagationtest1`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["propagation"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`ParamQuadSolve`propagation`"]],
    ...
    HoldComplete[VerificationTest[Module[{x, y, z, eq, vars, r, rhs}, eq = {x == 1, y == x + 1, z == y + 1}; vars = {x, y, z}; r = pqs[eq, vars, "ValidationOption" -> False]; rhs = r["Solution"][[All,2]]; FreeQ[rhs, Alternatives @@ vars]], True, {}, TestID -> "rhs-free-of-unknowns@@Tests/ParamQuadSolve/propagation_test1.wlt:10,1-21,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "propagation_test1",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../ParamQuadSolve/propagation_test1.wlt"
};
