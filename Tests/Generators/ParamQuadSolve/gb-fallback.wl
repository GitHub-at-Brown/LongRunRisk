(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/ParamQuadSolve/gb-fallback.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`gbfallback`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["gb-fallback Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`ParamQuadSolve`gbFallback`"]],
    ...
    HoldComplete[VerificationTest[Module[{x, y, eq, vars, r, steps, lastVar}, eq = {x^2 + y^2 == 1, x^2 + 2*y^2 == 2}; vars = {x, y}; r = pqs[eq, vars, "DomainOption" -> Reals, "ValidationOption" -> False]; steps = r["Diagnostics"]["Steps"]; lastVar = vars[[-1]]; MemberQ[steps, {"quadraticGB", lastVar}]], True, {}, TestID -> "gb-fallback-used@@Tests/ParamQuadSolve/gb-fallback.wlt:10,1-22,2"]],
    HoldComplete[VerificationTest[Module[{x, y, eq, vars, r}, eq = {x^2 + y^2 == 1, x^2 + 2*y^2 == 2}; vars = {x, y}; r = pqs[eq, vars, "DomainOption" -> Reals, "ValidationOption" -> False]; Length[Keys[r["SignRootMap"]]] >= 1], True, {}, TestID -> "sign-created-after-gb@@Tests/ParamQuadSolve/gb-fallback.wlt:24,1-34,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "gb-fallback",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../ParamQuadSolve/gb-fallback.wlt"
};
