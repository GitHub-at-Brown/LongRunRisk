(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/FindRootOptim/signIdxs.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`signIdxs`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["signIdxs Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`FindRootOptim`signIdxs`"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[f = ToExpression["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`Private`signIdxs"]; ],
    HoldComplete[VerificationTest[f[signA[3] + signA[1]^2 + other[2] + signB[5], "signA"], {1, 3}, TimeConstraint -> timeLimit, TestID -> "extracts-and-sorts-sign-indices@@Tests/FindRootOptim/signIdxs.wlt:12,1-17,6"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[f = ToExpression["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`Private`signIdxs"]; ],
    HoldComplete[VerificationTest[f[1 + other[2] + signB[5], "signA"], {}, TimeConstraint -> timeLimit, TestID -> "returns-empty-when-no-matching-head@@Tests/FindRootOptim/signIdxs.wlt:27,1-32,6"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "signIdxs",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../FindRootOptim/signIdxs.wlt"
};
