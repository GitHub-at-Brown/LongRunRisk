(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/FindRootOptim/normalizeExp.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`normalizeExp`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["normalizeExp Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`FindRootOptim`normalizeExp`"]],
    ...
    HoldComplete[VerificationTest[f[(E^a)[x]], Exp[a[x]], TimeConstraint -> timeLimit, TestID -> "wraps-E^a-application-as-Exp@@Tests/FindRootOptim/normalizeExp.wlt:12,1-17,6"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[f = ToExpression["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`Private`normalizeExp"]; ],
    HoldComplete[VerificationTest[f[E^(a[x] + b[x])], Exp[a[x] + b[x]], TimeConstraint -> timeLimit, TestID -> "normalizes-standard-E-power@@Tests/FindRootOptim/normalizeExp.wlt:27,1-32,6"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[f = ToExpression["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`Private`normalizeExp"]; ],
    HoldComplete[VerificationTest[f[Sin[x]], Sin[x], TimeConstraint -> timeLimit, TestID -> "leaves-non-E-expressions-unchanged@@Tests/FindRootOptim/normalizeExp.wlt:42,1-47,6"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "normalizeExp",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../FindRootOptim/normalizeExp.wlt"
};
