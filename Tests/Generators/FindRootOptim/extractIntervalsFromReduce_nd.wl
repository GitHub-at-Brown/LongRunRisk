(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/FindRootOptim/extractIntervalsFromReduce_nd.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`extractIntervalsFromReducend`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["extractIntervalsFromReduce_nd Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`FindRootOptim`extractIntervalsFromReduceNd`"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[VerificationTest[FernandoDuarte`LongRunRisk`Tools`FindRootOptim`extractIntervalsFromReduce[True, A[0]], {{0.002, 14.998}}, TimeConstraint -> timeLimit, TestID -> "extractIntervalsFromReduce-true-scalar@@Tests/FindRootOptim/extractIntervalsFromReduce_nd.wlt:11,1-16,2"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[VerificationTest[FernandoDuarte`LongRunRisk`Tools`FindRootOptim`extractIntervalsFromReduce[False, {A[0], B[1][0]}], {}, {extractIntervalsFromReduce::nointervals}, TimeConstraint -> timeLimit, TestID -> "extractIntervalsFromReduce-false-nd@@Tests/FindRootOptim/extractIntervalsFromReduce_nd.wlt:25,1-31,2"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`FindRootOptim`"]; ],
    HoldComplete[timeLimit = 5; ],
    HoldComplete[VerificationTest[FernandoDuarte`LongRunRisk`Tools`FindRootOptim`extractIntervalsFromReduce[Inequality[1, LessEqual, A[0], LessEqual, 5], {A[0], B[1][0]}], {{{1.001, -100000.}, {4.999, 100000.}}}, TimeConstraint -> timeLimit, TestID -> "extractIntervalsFromReduce-nd-padding@@Tests/FindRootOptim/extractIntervalsFromReduce_nd.wlt:40,1-48,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "extractIntervalsFromReduce_nd",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../FindRootOptim/extractIntervalsFromReduce_nd.wlt"
};
