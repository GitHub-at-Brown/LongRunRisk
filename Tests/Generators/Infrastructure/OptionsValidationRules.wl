(* Auto-generated from: /Users/fduarte/Library/CloudStorage/Dropbox-Personal/MyPackages/LongRunRisk-feat-gen-tests/Tests/Infrastructure/OptionsValidationRules.wlt
   by WLTTestRefactor` on 2026-01-03
   DO NOT EDIT BY HAND. Edit the generator or the original sources instead.
*)

BeginPackage["WLTGenerated`OptionsValidationRules`"];
...
$sourceExpressions = {
    HoldComplete[BeginTestSection["OptionsValidationRules Tests"]],
    HoldComplete[Begin["FernandoDuarte`LongRunRisk`Tests`Infrastructure`OptionsValidationRules`"]],
    HoldComplete[Needs["FernandoDuarte`LongRunRisk`Tools`OptionsValidationRules`"]; ],
    HoldComplete[timeLimit = 10; ],
    HoldComplete[VerificationTest[Quiet[Check[FernandoDuarte`LongRunRisk`Tools`OptionsValidationRules`InstallOptionsValidationRules[], $Failed]], True | $Failed, SameTest -> MatchQ, TimeConstraint -> timeLimit, TestID -> "InstallOptionsValidationRules-returns-true@@Tests/Infrastructure/OptionsValidationRules.wlt:11,1-22,2"]],
    HoldComplete[VerificationTest[Module[{available}, available = Quiet[Check[Needs["OptionsValidation`"]; True, False]]; If[ !available, True, Quiet[Needs["FernandoDuarte`LongRunRisk`Tools`ManageResources`"]; FernandoDuarte`LongRunRisk`Tools`OptionsValidationRules`InstallOptionsValidationRules[]; With[{bm = FernandoDuarte`LongRunRisk`Tools`ManageResources`buildModels}, result = OptionsValidation`ValidateOptions[bm, "FromScratch" -> "invalid"]; TrueQ[result] || result === False]]]], True, TimeConstraint -> timeLimit, TestID -> "buildModels-invalid-FromScratch-triggers-validation@@Tests/Infrastructure/OptionsValidationRules.wlt:26,1-49,2"]],
    HoldComplete[End[]],
...
Options[GenerateWLT] = {
    ...
    "TestIDPrefix" -> "OptionsValidationRules",
    "HashLength" -> 8,
    "TargetRelativeWLTPath" -> "../../Infrastructure/OptionsValidationRules.wlt"
};
