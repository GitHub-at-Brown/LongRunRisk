...
VerificationTest[
	...
	{}
	,
	TestID->"Shocks_20251223-40LIZY@@Tests/Shocks.wlt:3,1-12,2"
]
VerificationTest[
	...
	{}
	,
	TestID->"Shocks_20251223-AVT46T@@Tests/Shocks.wlt:13,1-21,2"
]
VerificationTest[
	!SameQ[Names @ "*rulesE", {}]
	,
...
VerificationTest[
	...
	{}
	,
	TestID->"Shocks_20251223-YEV9IQ@@Tests/Shocks.wlt:31,1-50,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-B4YKQ7@@Tests/Shocks.wlt:51,1-70,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-3S6A1J@@Tests/Shocks.wlt:71,1-90,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-2XD9EI@@Tests/Shocks.wlt:91,1-110,2"
]
VerificationTest[
	Apply[And,
		Flatten[
...
VerificationTest[
	...
	{}
	,
	TestID->"Shocks_20251223-U3G5UH@@Tests/Shocks.wlt:173,1-208,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-Q140R5@@Tests/Shocks.wlt:209,1-233,2"
]
VerificationTest[
	Apply[And,
		Flatten[
...
VerificationTest[
	...
	{}
	,
	TestID->"Shocks_20251223-D9MOEK@@Tests/Shocks.wlt:262,1-296,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-DD6HSL@@Tests/Shocks.wlt:297,1-316,2"
]
VerificationTest[
	Apply[And,
		Flatten[
	...
	{}
	,
	TestID->"Shocks_20251223-Z3LKCQ@@Tests/Shocks.wlt:317,1-336,2"
] 
VerificationTest[
  $ContextPath = Select[$ContextPath,  !(StringContainsQ[#1, "FernandoDuarte`LongRunRisk`"] && StringEndsQ[#1, "Private`"]) & ]; True,
  True,
  TestID -> "Untitled-22@@Tests/Shocks.wlt:337,1-345,8"
]
End[]
EndTestSection[]
